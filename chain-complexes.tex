...
We distinguish between \defn{short} and \defn{long exact sequences}, where short exact sequences are exact sequences with three or fewer consecutive non-zero groups, i.e. sequences of the form
...
\end{tikzcd}\]
\begin{enumerate}[(a)]
    \item If there exists a \defn{section} $s:C\rightarrow B$ of $g$, then $f$ and $s$ define an isomorphism $$(f+s):A\dsum C\iso B$$
$$(a,c)\mapsto f(a)+s(c).$$
