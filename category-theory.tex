...
\par Two definitions that will play a big role in our study are notions of "maps between categories" and "maps between maps between categories". These are called \defn{functors} and \defn{natural transformations}, respectively.
